                      ...
                      tabPanel("Life history parameters",
                               ...
                               fluidPage(
                                 fluidRow(
                                   ...
                                   column(width = 6,
                                          shinydashboard::box(title = h4("Summary"),
                                          ...
                                          shinyBS::bsTooltip(id = "Linf_label",#"numLinf", 
                                                    ...
                                                    placement = "left", trigger = "hover",  options = list(container = "body")),
                                          shinyBS::bsTooltip(id = "CVLinf_label", # "CVLinf", 
                                                    ...
                                                    placement = "left", trigger = "hover",  options = list(container = "body")),
                                          shinyBS::bsTooltip(id = "Lm50_label", #"numLm50", 
                                                    ...
                                                    placement = "left", trigger = "hover",  options = list(container = "body")),
                                          shinyBS::bsTooltip(id = "Lm95_label", #"numLm95", 
                                                    ...
                                                    placement = "left", trigger = "hover",  options = list(container = "body")),
                                          shinyBS::bsTooltip(id = "natMortalityRadioBtn", 
                               ...
                               fluidRow(
                                 ...
                                 column(width = 4, 
                                        ...
                                        actionButton(inputId = "fitGrowth", label = "Fit LVB curve",
                                                     class = "btn-success"),
                                        shinyBS::bsTooltip(id = "fitGrowth", 
                                   ...
                                   column(width = 3,
                                          ...
                                          tabsetPanel(
                                            ...
                                            tabPanel("LIME",
                                                     ...
                                                     # tooltips
                                                     shinyBS::bsTooltip(id = "limeSigmaR", 
                                                               ...
                                                               placement = "left", trigger = "hover",  options = list(container = "body")),
                                                     shinyBS::bsTooltip(id = "limeSigmaF", 
                                                               ...
                                                               placement = "left", trigger = "hover",  options = list(container = "body")),
                                                     shinyBS::bsTooltip(id = "limeSigmaC", 
                                                               ...
                                                               placement = "left", trigger = "hover",  options = list(container = "body")),
                                                     shinyBS::bsTooltip(id = "limeSigmaI", 
                                                     ...
                                                     shinyBS::bsTooltip(id = "limeTheta", 
                                                               ...
                                                               placement = "left", trigger = "hover",  options = list(container = "body")),
                                                     shinyBS::bsTooltip(id = "limeNseasons", 
